...
| Major medical protection | Broad protection from routine and catastrophic medical expense | **No** |
| HSA eligibility | Whether the person has qualifying HDHP coverage and no disqualifying coverage | **Only when separately and deliberately designed for it** |
...
| HRSA-supported Women's Preventive Services Guidelines | Evidence-informed preventive care and screenings for women not already captured by specified USPSTF recommendations |
...
| Financial | Can it be funded predictably without defeating the low-cost purpose? |
...
| **Incremental** | Often completed inside an office or preventive visit; the listed amount represents likely additional plan cost rather than the entire visit |
