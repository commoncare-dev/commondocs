---
id: product.alternative-companion
title: Private Alternatives Alongside an Employer Plan
kind: human-readable
status: draft
owner: CommonCare
---
...
|---|---|
| What does the employer sponsor? | Only the options identified in the employer's formal plan documents and enrollment materials |
| Can employees choose something else? | Yes, through a clearly separate voluntary marketplace or by selecting their own option |
| Does the employer recommend private alternatives? | No |
| Does CommonCare sell or receive product commissions? | No; options are compared using the same disclosed analytical framework |
...
| Ordinary taxable compensation | Employer health reimbursement |
|---|---|
| Paid whether or not the employee buys the option | Paid only if the employee buys or proves purchase |
| Available for any purpose | Restricted to the product or medical expense |
| Reported and taxed as wages | Functions as employer health-plan funding despite a post-tax label |
| Employee controls subsequent spending | Employer conditions access on health behavior |
...
| Dimension | Employer insurance | Private alternative |
|---|---|---|
| Regulatory status | Employer-sponsored group coverage | Individual contract or membership |
| Payment promise | Governed by policy and insurance law | Governed by the option's actual agreement |
| Pre-existing conditions | Generally protected under ACA rules | May be limited or excluded |
| Maximum exposure | Usually contractually capped for covered in-network essential benefits | May be capped, shared, limited, discretionary, or uncapped |
| Provider access | Usually network-dependent | May use cash pricing, direct contracts, broad access, or its own limitations |
| Price sensitivity | Often obscured by premium and claims administration | Frequently more direct and visible |
| Employer role | Sponsor and administrator | None |
